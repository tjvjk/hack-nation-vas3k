...
- **Data Architecture and Intelligence (30%):** How well does the system collect, structure, and manage founder data? We look for smart ingestion, deduplication, enrichment, and a reasoning layer that is honest about what it knows and what it does not. *Note: generic ingestion / enrichment quality alone will not score highly here if it doesn't address the cold-start, pre-track-record case.*
