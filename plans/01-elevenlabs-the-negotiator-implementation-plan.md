...
1. **Agent 1 — Estimator** проводит голосовое интервью, дополняет его данными из загруженного документа, формирует единую спецификацию переезда и просит пользователя подтвердить её.
